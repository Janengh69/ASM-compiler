    ...
    for i in lex_list:
       ...
       for j in range(len(i)):
            ...
            if((j == 0 and i[j][1] == 'USER') or (j == 0 and i[j][1] == 'USER_MACRO') or (j != len(i)-1 and i[j][1] == 'USER' and i[j+1][0] == ':')):
                ...
                table[pos][1] = [count, 1]
            elif( i[j][1] == 'DIRECTIVE' or i[j][1] == 'SYMBOL' or i[j][1] == 'USER' or i[j][1] == 'USER_MACRO' or i[j][1] == 'ID_SEGMENT' or i[j][1] == 'REGISTER16' or i[j][1] == 'REGISTER8' or i[j][1] == 'TEXTCONST' or i[j][1] == 'NUMBER'):
